...
import ContanctUsPageGraphic from "@/assets/ContactUsPageGraphic.png";
        ...
        <div className="mt-10 justify-between gap-8 md:flex">
            ...
            >
                <form 
                    target="_blank"
                    onSubmit={onSubmit}
                    action="https://formsubmit.co/randommail@gmail.com"
                    method="POST"
                >
                    <input 
                        type="text" 
            ...
            >
                ...
                >
                    <img className="w-full" src={ContanctUsPageGraphic} alt="contact-us-page-graphic" />
                </div>
            </motion.div>
        </div>
    </motion.div>
